                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tag" value="{!!old('tag',@$edit->tag)!!}">
                 
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Body <span style="color:red" >*</span></label>
                 <textarea name="body" id="" cols="30" rows="10" class="form-control">{!!old('body',@$edit->body)!!}</textarea>
